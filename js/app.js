const app = new (function Application(){
    ...
    this.stopSelf = function(){
        carsControl.carSelf.stop = !carsControl.carSelf.stop;
    };
    this.stopOther = function(){
        carsControl.carOther.stop = !carsControl.carOther.stop;
    };
    ...
    function initView(){
        ...
        var len = 1000;
        camera.position.set(0,control.maxHeight+60,80+_offsetZ);
    ...
    function initWorld(){
        ...
        this.update = function () {
            this.offset.y = -carsControl.carSelf.position.z;//////////////////////////
    ...
    function initCars(){
        ...
        this.update = function () {
            this.carSelf.moveUpdate();
            this.carOther.moveUpdate();
        }
        this.reset = function () {
            this.carSelf.reset();
            this.carOther.reset();
        ...
        function initCar(position,rotation){
            var car = randomPick(objects.cars).clone();
            chunkScene.add(car);
