...
<div id="page-cont" class="page hidden">
    ...
    <p>
    ①　你将作为自动驾驶汽车的车主，朝十字路口方向行驶，并将在十字路口直行，十字路口对面有一辆即将左转的自动驾驶车辆（如图1）。我方汽车可以检测对方的社会价值取向(亲社会、亲自我、中立)，并自行做出<b>直行</b>或<b>让行</b>的决策，你可以对该决策进行修改。需要注意的是，社会价值取向只表示对方的一种倾向，并不和其是否让行相对应，如亲社会的汽车并不总是让行。
    </p>
    <p>
    ②　你将作为自动驾驶汽车的车主，朝十字路口方向行驶，并将在十字路口左转，十字路口对面有一辆即将直行的自动驾驶车辆。我方汽车可以检测对方的社会价值取向(亲社会、亲自我、中立)，并自行做出<b>左转</b>或<b>让行</b>的决策，你可以对该决策进行修改。需要注意的是，社会价值取向只表示对方的一种倾向，并不和其是否让行相对应，如亲社会的汽车并不总是让行。
    </p>
</div>
<!-- 实验说明页1 -->
