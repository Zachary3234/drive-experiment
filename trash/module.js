...
!function boot(modules, config, bootModule) {
        ...
        THREE.MaterialLoader.prototype.parse = function(options) {
            ...
            if (options.customType && "MatcapMaterial" === options.customType) {
                return images.create({
                    ...
                    matcapMap : THREE.ImageUtils.loadTexture("assets/textures/matcap.jpg"),
                    normalMapFactor : 1
                });
            }
    ...
    43 : [function(require, module, n) {
        ...
        _.inherit(ref, {
            start : function(_) {
                var blocks = _.getObjectByName("blocks").children;
                var lanes = _.getObjectByName("lanes").children;
                var intersections = _.getObjectByName("intersections").children;
                var cars = _.getObjectByName("cars").children;
                var clouds = _.getObjectByName("clouds").children;
                this.table = new SVGTable(blocks, lanes, intersections, cars, clouds);
    ...
    51 : [function(canCreateDiscussions, mixin, n) {
        /** @type {!Array} */
        mixin.exports = ["assets/textures/white.png", "assets/textures/normal.png", "assets/textures/vignetting.png"];
    }, {}],
    ...
    60 : [function(parseValueFn, context, n) {
        ...
        var init = function() {
            ...
            this._quad.material = new THREE.MeshBasicMaterial({
                map : value.getTexture("assets/textures/vignetting.png"),
                transparent : true,
                opacity : .25
            });
        };
